...
class CartCell: UICollectionViewCell {
    static let indetifier = "CartCell"
    ...
    private func setConstraintsCartButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            cartButton.widthAnchor.constraint(greaterThanOrEqualToConstant: 130),
            cartButton.heightAnchor.constraint(greaterThanOrEqualToConstant: 40)
        ])
    }
